...
public class Shrdlite {
	...
	public static void main(String[] args) throws PrologException, ParseException, IOException {
        ...
        JSONObject blocks    = (JSONObject) jsinput.get("blocks");

        JSONObject result = new JSONObject();
        result.put("utterance", utterance);

        // // This is how to get information about the top block in column 1:
        // JSONArray column = (JSONArray) world.get(1);
        // String topblock = (String) column.get(column.size() - 1);
        // JSONObject blockinfo = (JSONObject) blocks.get(topblock);
        // String form = (String) blockinfo.get("form");
        ...
        if (trees.isEmpty()) {
            ...
            // Interpreter interpreter = new Interpreter(world, blocks);
            for (Term tree : trees) {
            ...
            if (goals.isEmpty()) {
                ...
                // Planner planner = new Planner(world, blocks);
