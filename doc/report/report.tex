...
\begin{document}
	...
	the desired outcome. \\
        ...
        Moreover we tryied to implement a Partial-Order planner but time was not 
        enough for this purpouse.  Anyway we have a draft version of the 
...
\end{verbatim}
        ...
        This simple representation is enough to handle all cases where ``the'' and
        ``any'' quantifier are involved.  \\

        When we need to handle all quantifier we have to add the notion of 
